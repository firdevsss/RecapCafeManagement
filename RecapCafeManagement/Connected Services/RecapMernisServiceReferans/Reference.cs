...
namespace RecapMernisServiceReferans
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="RecapMernisServiceReferans.KPSPublicSoap")]
    public interface KPSPublicSoap
    {
        ...
        System.Threading.Tasks.Task<RecapMernisServiceReferans.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(RecapMernisServiceReferans.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest
    {
        ...
        public RecapMernisServiceReferans.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(RecapMernisServiceReferans.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse
    {
        ...
        public RecapMernisServiceReferans.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(RecapMernisServiceReferans.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    public interface KPSPublicSoapChannel : RecapMernisServiceReferans.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<RecapMernisServiceReferans.KPSPublicSoap>, RecapMernisServiceReferans.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<RecapMernisServiceReferans.TCKimlikNoDogrulaResponse> RecapMernisServiceReferans.KPSPublicSoap.TCKimlikNoDogrulaAsync(RecapMernisServiceReferans.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<RecapMernisServiceReferans.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            RecapMernisServiceReferans.TCKimlikNoDogrulaRequest inValue = new RecapMernisServiceReferans.TCKimlikNoDogrulaRequest();
            inValue.Body = new RecapMernisServiceReferans.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((RecapMernisServiceReferans.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
        ...
        internal bool TCKimlikNoDogrula(long v1, string firstName, string v2, int ıd, int year)
        {
